...
- **Database**: IndexedDB (`OpenCourseDB`, `db.js`) + Web Crypto API (AES-256-GCM)
...
- Maintain OKLCH color palettes and multi-layered neutral elevation depth tokens defined in `DESIGN.md`.
