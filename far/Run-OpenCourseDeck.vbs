...
' OpenCourseDeck app-like one-click launcher (Windows)
...
cmdPath = Chr(34) & workingDir & "\Run-OpenCourseDeck.cmd" & Chr(34)

' 0 = hidden window, False = don't wait
' If nothing opens, try running Run-OpenCourseDeck.cmd directly to see console output.
