function s({setView:t}={}){t(`
  ...
  `);try{window.PlasmaNotesApp?.init?.()}catch(a){console.warn("[Notes view] init failed",a)}return{beforeLeave(){try{window.PlasmaNotesApp?.flushPendingSave?.()}catch{}},unmount(){try{window.PlasmaNotesApp?.destroy?.()}catch{}}}}export{s as mountNotesView};
//# sourceMappingURL=notesRoute-GY2DHM6T.js.map
