function s({setView:t}={}){return t(`
  ...
  `),window.PlasmaDeck?.ProgressStatsInit?.(),{unmount(){try{window.PlasmaDeck?.ProgressStats?.destroy?.()}catch{}}}}export{s as mountProgressView};
//# sourceMappingURL=progressRoute-SELD4K2E.js.map
